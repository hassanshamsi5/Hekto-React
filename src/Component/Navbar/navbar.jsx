        ...
        <>
            <div className='bg'>
                <div className="container text-white">
                    <header className="d-flex flex-wrap">
                        ...
                        <a className="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none" aria-current="page" href="/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
                        ...
                        <ul className="nav nav-pills">
                            <li className="nav-item">
                                <a className="nav-link" aria-current="page" href="/">English</a>
                            </li>
                            <li className="nav-item">
            ...
            <nav className="navbar navbar-expand-lg main-content">
                <div className="container">
                    <a className="navbar-brand fw-bold main-content-1" href="/"><h1>Hekto</h1></a>

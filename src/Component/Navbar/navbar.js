            ...
            {/* <div> */}
                <nav className="navbar navbar-expand-lg bg text-white">
                    <div className="container">
                        ...
                        <a className="navbar-brand" aria-current="page" href="/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <form className="d-flex" role="search">
                                    ...
                                    <button className="btn btn-danger border-none" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
